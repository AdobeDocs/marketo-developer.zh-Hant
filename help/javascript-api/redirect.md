...
| &#39;傳送&#39; | 必填 | 字串 | 方法動作。 |
| &#39;重新導向&#39; | 必填 | 字串 | 方法名稱。 |
| field_name | 必填 | 字串 | 要比對的欄位名稱。 範例： &#39;abm.name&#39; （請參閱下文）。 |
| values_array | 必填 | 陣列 | 比對欄位的值清單（不區分大小寫）。 |
| redirect_url | 必填 | 字串 | 將符合條件的訪客重新導向的目標URL。 |
...
| 條件 | 資料階層 | 範例 |
|-------------------------------------------------|----------------------|------------------------------------------------------------------------------------------------------------------|
| 相符的區段（僅在首次點按後運作） | matchedSegments.name | rtp( &#39;send&#39;， &#39;redirect&#39; ， &#39;matchedSegments.name&#39; ， [&#39;財富1,000強&#39; ， &#39;企業&#39;] ， &#39;http://www.marketo.com&#39;)； |
...
| 位置 | location.country | rtp( &#39;send&#39;， &#39;redirect&#39; ， &#39;location.country&#39; ， [&#39;美國&#39;]， &#39;http://www.marketo.com&#39;)； |
| 位置 | location.state | rtp( &#39;send&#39;， &#39;redirect&#39; ， &#39;location.state&#39;， [&#39;ca&#39;]， &#39;http://www.marketo.com&#39;)； |
| 位置 | location.city | rtp( &#39;send&#39;， &#39;redirect&#39; ， &#39;location.city&#39;， [&#39;聖馬特奧&#39;]， &#39;http://www.marketo.com&#39;)； |
| 產業 | 產業 | rtp( &#39;send&#39;， &#39;redirect&#39;， &#39;industries&#39; ， [&#39;教育&#39;]， &#39;http://www.marketo.com&#39;)； |
| ISP | isp | rtp( &#39;send&#39;， &#39;redirect&#39; ， isp ， [&#39;假&#39;]， &#39;http://www.marketo.com&#39;)； |
...
| &#39;傳送&#39; | 必填 | 字串 | 方法動作。 |
| &#39;重新導向&#39; | 必填 | 字串 | 方法名稱。 |
| field_name | 必填 | 字串 | 要比對的欄位名稱。 範例： &#39;abm.name&#39; （請參閱上文）。 |
| url_values_map | 必填 | 物件 | 在重新導向URL和值清單之間對應。 範例：{&#39;http://marketo.com&#39; ： [&#39;first_abm&#39;， &#39;second_abm&#39;]} |
